...
<body>
    ...
    <h1 id="title">Manage Your Download History</h1>
    ...
    <h2 id="message" style="visibility: hidden; text-align: center;">
      Your Download History is Empty.<br>Please come back later.
    </h2>
    <script>
        var url = window.location.href;
        var length = url.length;
        var page = 1;
        var prefix = "http://localhost/Meta-Stream/myaccount/download_history/downloadhistory.php";
        ...
        t = document.getElementById("downloadhistory");
